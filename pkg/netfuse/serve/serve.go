...
type FS interface {
	...
	Statfs(req *fuse.StatfsRequest, resp *fuse.StatfsResponse) error
	Getattr(req *fuse.GetattrRequest, resp *fuse.GetattrResponse) error
}
