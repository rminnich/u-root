...
// Templates are a shorthand for groups of commands.
// They can be used in other commands, e.g. gobusybox:
// makebb `template plan9`
// It is acceptable to use a name more than once, or to
// use names that overlap. They were inspired by Plan 9's
// libndb (search man plan9 ndb)
